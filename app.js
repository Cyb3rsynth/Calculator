...
//Helper function for UpdateScreen (to be called within)
    getDisplayInteger(number) {
...
//This function updates the display output
    updateScreen() {
        this.currentOperandTextElement.innerText = this.getDisplayInteger(this.currentOperand)
        if (this.operation != null) {
            this.previousOperandTextElement.innerText =
             `${this.getDisplayInteger(this.previousOperand)} ${this.operation}`
        } else {
          this.previousOperandTextElement.innerText = ''
        }
    }
